...
def video_to_frames(
    ...
    Output Structure:
        output_root/
        └── <video_name>/
            ├── <video_name>_frame_00000.jpg
            ├── <video_name>_frame_00001.jpg
            └── ...

    Parameters:
        video_path (str): Video path
        output_root (str): Output parent directory (provided manually by you)
        image_ext (str): Output image format, e.g., ".jpg" ".png"
        target_fps (int | None): Target frame extraction FPS
    """
